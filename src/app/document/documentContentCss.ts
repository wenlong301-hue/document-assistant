...
export const docContentCss = (prefix: string): string => {
  ...
  return [
    ...
    `${p} table td,${p} table th,${p} .doc-table td,${p} .doc-table th{border:1px solid #EEF0F5;box-sizing:border-box;min-width:96px;padding:7px 9px;position:relative;vertical-align:top;text-align:left;font-size:14px}`,
    `${p} table th,${p} .doc-table th{background:#f7f8fa;color:#131212;font-weight:600}`,
