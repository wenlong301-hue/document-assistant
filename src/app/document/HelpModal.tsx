        ...
        <div className="flex items-center justify-between px-[24px] h-[56px] shrink-0 border-b border-[#ebecf0]">
          <div className="flex items-center gap-[10px] min-w-0">
            ...
            {onCheckUpdate && (
              <button
                type="button"
                className="h-[28px] px-[10px] rounded-[8px] border border-[#EBECF0] bg-white text-[12px] text-[#131212] cursor-pointer hover:bg-[#F7F8FA] active:bg-[#EBECF0] disabled:opacity-50 disabled:cursor-not-allowed transition-colors font-['PingFang_SC:Regular',sans-serif]"
                onClick={(e) => {
                  e.stopPropagation();
                  onCheckUpdate();
                }}
            ...
            {SECTIONS.map((section) => {
              ...
              return (
                <button
                  ...
                  className={`w-full text-left rounded-[8px] px-[12px] py-[9px] text-[13px] mb-[2px] border-0 outline-none appearance-none transition-colors cursor-pointer font-['PingFang_SC:Regular',sans-serif] ${
                    selected
                      ? "bg-[#eef0f5] text-[#131212] font-medium"
                      : "bg-transparent text-[#606266] hover:bg-[#f0f1f5]"
                  }`}
                >
                  {section.title}
                </button>
