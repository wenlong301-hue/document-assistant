import svgPaths from "./svg-8pwaal4bp9";

function Frame() {
  return (
    <div className="-translate-x-1/2 absolute h-[300px] left-1/2 top-[240px] w-[400px]" data-name="Frame">
...
function Frame1() {
  return (
    <div className="absolute bg-white h-[1006px] left-[calc(8.33%+148px)] overflow-clip rounded-[12px] top-[66px] w-[1604px] px-[14px] py-[0px]">
      <p className="[word-break:break-word] absolute font-['PingFang_SC:Medium',sans-serif] leading-[28px] left-[24px] not-italic text-[#131212] text-[20px] top-[16px] whitespace-nowrap">文档名称1</p>
      <div className="absolute h-0 left-0 top-[60px] w-[1604px]">
        <div className="absolute inset-[-0.3px_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1604 0.6">
            <path d="M0 0.3H1604" id="Vector 1" stroke="var(--stroke-0, #EBECF0)" strokeWidth="0.6" />
          </svg>
        </div>
      </div>
      <p className="[word-break:break-word] absolute font-['PingFang_SC:Regular',sans-serif] leading-[normal] left-[calc(50%-133px)] not-italic text-[#93959f] text-[14px] top-[540px] whitespace-nowrap">该文档暂无内容，请在大纲模式下创建内容</p>
      <Frame />
    </div>
  );
}
...
function Group1() {
  return (
    <div className="absolute contents left-[20px] top-[78px]">
      <div className="absolute bg-white border-[#ececec] border-[0.6px] border-solid h-[32px] left-[20px] rounded-[8px] top-[78px] w-[276px]" />
      <p className="[word-break:break-word] absolute font-['PingFang_SC:Regular',sans-serif] leading-[normal] left-[52px] not-italic text-[#c0c4cc] text-[14px] top-[84px] w-[78.471px]">搜索文件</p>
      <Search />
    </div>
  );
}
...
function Frame11() {
  return (
    <div className="absolute content-stretch flex h-[66px] items-center justify-between left-0 pl-[20px] pr-[8px] py-[16px] top-0 w-[1920px]">
      <Frame5 />
      <Frame9 />
    </div>
  );
...
function Folder() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="folder">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="folder">
          <path d={svgPaths.p2d6a180} id="Icon" stroke="var(--stroke-0, #131212)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
        </g>
      </svg>
    </div>
  );
...
function Frame18() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-center min-w-px relative">
      <Folder />
      <p className="[word-break:break-word] flex-[1_0_0] font-['PingFang_SC:Regular',sans-serif] leading-[normal] min-w-px not-italic overflow-hidden relative text-[#131212] text-[14px] text-ellipsis whitespace-nowrap">文档名称1</p>
    </div>
  );
}
...
function Folder1() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="folder">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="folder">
          <path d={svgPaths.p2d6a180} id="Icon" stroke="var(--stroke-0, #93959F)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
        </g>
      </svg>
    </div>
  );
...
function Frame20() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-center min-w-px relative">
      <Folder1 />
      <p className="[word-break:break-word] flex-[1_0_0] font-['PingFang_SC:Regular',sans-serif] leading-[normal] min-w-px not-italic overflow-hidden relative text-[#93959f] text-[14px] text-ellipsis whitespace-nowrap">文档名称2</p>
    </div>
  );
}
...
function Frame22() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-center min-w-px relative">
      <Folder2 />
      <p className="[word-break:break-word] flex-[1_0_0] font-['PingFang_SC:Regular',sans-serif] leading-[normal] min-w-px not-italic overflow-hidden relative text-[#93959f] text-[14px] text-ellipsis whitespace-nowrap">文档名称3</p>
    </div>
  );
}
...
function Frame24() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-center min-w-px relative">
      <Folder3 />
      <p className="[word-break:break-word] flex-[1_0_0] font-['PingFang_SC:Regular',sans-serif] leading-[normal] min-w-px not-italic overflow-hidden relative text-[#93959f] text-[14px] text-ellipsis whitespace-nowrap">文档名称4</p>
    </div>
  );
}
...
function Frame26() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-center min-w-px relative">
      <Folder4 />
      <p className="[word-break:break-word] flex-[1_0_0] font-['PingFang_SC:Regular',sans-serif] leading-[normal] min-w-px not-italic overflow-hidden relative text-[#93959f] text-[14px] text-ellipsis whitespace-nowrap">文档名称5超长文本演示文档名称鸣海</p>
    </div>
  );
}
...
function FolderOpen1() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="folder-open-02">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="folder-open-02">
          <path d={svgPaths.p9eb87c0} id="Icon" stroke="var(--stroke-0, #131212)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
        </g>
      </svg>
    </div>
  );
...
function Frame2() {
  return (
    <div className="content-stretch flex gap-[8px] items-center px-[8px] py-[7px] relative shrink-0">
      <FolderOpen1 />
      <p className="[word-break:break-word] font-['PingFang_SC:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#131212] text-[16px] whitespace-nowrap">文档</p>
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="content-stretch flex gap-[8px] items-center p-[8px] relative shrink-0">
      <Plus />
      <p className="[word-break:break-word] font-['PingFang_SC:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#131212] text-[14px] whitespace-nowrap">新建文档</p>
    </div>
  );
}
...
function FolderOpen() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="folder-open-02">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="folder-open-02">
          <path d={svgPaths.p3d9dd500} id="Icon" stroke="var(--stroke-0, #93959F)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
        </g>
      </svg>
    </div>
  );
...
function Frame4() {
  return (
    <div className="absolute content-stretch flex gap-[8px] items-center left-[20px] px-[8px] py-[9.5px] top-[170px] w-[276px]">
      <FolderOpen />
      <p className="[word-break:break-word] font-['PingFang_SC:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#93959f] text-[12px] whitespace-nowrap">文档位置名称</p>
    </div>
  );
}
